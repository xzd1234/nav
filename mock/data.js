  ...
  menuList: [
    {
      ...
      list: [
        {
          name: "腾讯云",
          desc: "产业智变 云启未来",
          icon: "/nav/ico/tencent.ico",
          url: "https://cloud.tencent.com/"
        },
        {
          name: "阿里云",
          desc: "上云就上阿里云",
          icon: "/nav/ico/aliyun.ico",
          url: "https://www.aliyun.com/"
        },
        {
          name: "华为云",
          desc: "智能，见未来",
          icon: "/nav/ico/huawei.png",
      ...
      list: [
...

        {
          name: "Uniapp",
          desc: "基于Vue的跨端框架",
          icon: "/nav/ico/uniapp.png",
          url: "https://uniapp.dcloud.io/"
        },
        {
          name: "Mpvue",
          desc: "基于Vue的小程序框架",
          icon: "/nav/ico/mpvue.png",
          url: "http://mpvue.com/"
        },
        {
          name: "Taro",
          desc: "多端统一开发解决方案",
          icon: "/nav/ico/taro.ico",
    ...
    },
    {
      ...
      list: [
...

        {
          ...
          icon: "/nav/ico/github.png",
          url: "https://github.com/"
        },
        {
          name: "Gitee",
          desc: "中国最大开源及私有软件项目的托管平台",
          icon: "/nav/ico/gitee.png",
          url: "https://gitee.com/"
        },
        {
          name: "知乎",
          desc: "中国最大问答社区",
          icon: "/nav/ico/zhihu.png",
          url: "https://zhihu.com/"
        },
        {
          name: "简书",
          desc: "一个写作的社区",
          icon: "/nav/ico/jianshu.png",
          url: "https://www.jianshu.com/"
        },
        {
          name: "博客园",
          desc: "面向开发者的知识分享社区",
          icon: "/nav/ico/bky.svg",
          url: "https://www.cnblogs.com/"
        }, {
          name: "吾爱破解",
          desc: "吾爱破解论坛致力于软件安全与病毒分析的前沿，由无数热衷于软件加密解密及反病毒爱好者共同维护 ",
          icon: "/nav/ico/wuaipojie.png",
          url: "https://www.52pojie.cn/"
        },
        {
          name: "印记中文",
          desc: "印记中文是最权威是技术中文文档社区",
          icon: "/nav/ico/docschina.png",
          url: "https://docschina.org/"
        },
        {
          name: "SegmentFault",
          desc: "一个专注于解决编程问题，提高开发技能的社区",
          icon: "/nav/ico/segmentfault.png",
          url: "https://segmentfault.com/"
        },
        {
          name: "CNode",
          desc: "Node.js专业中文社区",
          icon: "/nav/ico/cnodejs.png",
          url: "https://cnodejs.org/"
        },
        {
          name: "W3cplus",
          desc: "W3cplus是一个致力于推广国内前端行业的技术博客",
          icon: "/nav/ico/w3cplus.png",
      ...
      list: [
        {
          ...
          icon: "/nav/ico/echarts.png",
          url: "https://echarts.apache.org/zh/index.html"
        },
        {
          name: "Highcharts",
          desc: "兼容 IE6+、支持移动端、图表类型丰富的HTML5交互性图表库",
          icon: "/nav/ico/highcharts.png",
          url: "https://www.highcharts.com/"
        },
        {
          name: "Threejs",
          desc: "运行在浏览器中的3D 引擎",
          icon: "/nav/ico/threejs.png",
      ...
      list: [
        {
          name: "Iconfont",
          desc: "阿里巴巴矢量图标库",
          icon: "/nav/ico/iconfont.svg",
          url: "https://www.iconfont.cn/"
        }, {
          name: "iconpark",
          desc: "字节跳动旗下图标库",
          icon: "/nav/ico/iconp.svg",
          url: "https://iconpark.oceanengine.com/"
        },
        {
          name: "fontawesome",
          desc: "完美的图标字体 只为Bootstrap设计",
          icon: "/nav/ico/font-awesome.png",
      ...
      list: [
        {
          name: "vite",
          desc: "下一代前端开发与构建工具",
          icon: "/nav/ico/vite.png",
          url: "https://vitejs.cn/"
        },
        {
          name: "webpack",
          desc: "代码模块化构建打包工具",
          icon: "/nav/ico/webpack.png",
          url: "https://webpack.js.org/"
        },
        {
          name: "Gulp",
          desc: "基于流的自动化构建工具",
          icon: "/nav/ico/gulp.png",
          url: "https://www.gulpjs.com.cn/"
        },
        {
          name: "FIS3",
          desc: "FIS3 , 为你定制的前端工程构建工具",
          icon: "/nav/ico/fis.png",
          url: "https://fex-team.github.io/fis3/"
        },
        {
          name: "Browserify",
          desc: "遵循commonjs规范的模块化工具",
          icon: "/nav/ico/browserify.png",
      ...
      list: [
        {
          ...
          icon: "/nav/ico/qinghuajingxiang.png",
      ...
      list: [
        {
          name: "uigreat",
          desc: "优秀设计师的贴心伴侣",
          icon: "/nav/ico/uigreat.jpg",
          url: "https://uigreat.com/"
        },
        {
          name: "站酷",
          desc: "打开站酷,发现更好的设计",
          icon: "/nav/ico/zcool-favicon.jpg",
          url: "https://www.zcool.com.cn/"
        },
        {
          name: "ui中国",
          desc: "专业用户体验设计平台",
          icon: "/nav/ico/yearlogo.png",
          url: "https://www.ui.cn/"
        },
        {
          name: "花瓣",
          desc: "发现、采集你喜欢的UI设计素材、交互设计素材",
          icon: "/nav/ico/huaban.png",
          url: "https://huaban.com/"
        },
        {
          name: "蓝湖",
          desc: "高效的产品设计协作平台",
          icon: "/nav/ico/lanhu.png",
